Rails.application.routes.draw do
  ...
  match 'import_weight_csv', '/importWeight', :controller => 'weights', :action => 'csv_import', :via => 'get'
  match 'import_steps_csv'  '/importStep', :controller => 'steps', :action => 'csv_import', :via => 'get'
  match 'withings' '/withings', :controller => 'withings', :action => 'log', :via => 'get'
